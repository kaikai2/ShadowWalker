 ...
 * @constant
 */
const cc.CCACTION_TAG_INVALID = -1;
...
cc.Loader = cc.Class.extend(/** @lends cc.Loader# */{
    ...
    /**
     * Callback when there is an error in loading file
    ...
    /**
     * returns the progress in percentagedfsadasd
    ...
    /**
     * Callback function, you must ovewrite this
     * @type Virtual
     * @function
     */
    onload:undefined,
    /**
     * Custom error callback function, you must overwrite this
     * @function
     * @virtual
     */
    onerror:undefined,
    /**
     * Custom loading callback function, you must overwrite this
     * @function
     * @virtual
     */
    onloading:undefined,
    ...
    /**
     * Preload function description //TODO
     * @param res
     */
...
/**
 * The first line is default to description
 * @class
 */
...
/**
 * @returns {cc.shareLoaderScene} this is a blah blah blah
 */
